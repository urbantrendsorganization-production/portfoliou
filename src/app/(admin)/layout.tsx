    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-950 overflow-hidden">
      ...
      >
        ...
        <div className="px-3 py-4 border-t border-gray-200 dark:border-gray-700 shrink-0">
          <Link
            href="/dashboard"
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-gray-100 transition-colors"
          >
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full">
        {/* Mobile header */}
        <header className="flex items-center gap-4 px-4 py-3 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 lg:hidden shrink-0">
          <button
